...
Validate the target without uploading:

```bash
python 11/main.py --file Place.rbxl --place-id 123456789 --dry-run
```
...
| `--dry-run` | Validate authentication, file path, and target place without uploading. |
